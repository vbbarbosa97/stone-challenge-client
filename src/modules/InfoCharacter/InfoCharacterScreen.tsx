...
const InfoCharacterScreen: React.FC<RouteComponentProps> = props => {
  ...
  return <InfoCharacter comics={comics} loading={loading} navigateToDashboard={navigateToDashboard} />;
};
